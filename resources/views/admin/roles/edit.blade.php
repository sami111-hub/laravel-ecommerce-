...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h4><i class="bi bi-shield-check"></i> تعديل الدور: {{ $role->name }}</h4>
        ...
        <form action="{{ route('admin.roles.update', $role) }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control @error('description') is-invalid @enderror" 
                          ...
                          placeholder="وصف مختصر للدور وصلاحياته...">{{ old('description', $role->description) }}</textarea>
                @error('description')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="mb-3">
                <div class="form-check form-switch">
                    ...
                    <label class="form-check-label fw-bold" for="is_active">
                        <i class="bi bi-toggle-on"></i> تفعيل الدور
                    </label>
                </div>
            </div>
            ...
            <div class="mb-3">
                <div class="form-check mb-3">
                    <input class="form-check-input" type="checkbox" id="select-all"
                           {{ count($permissions->flatten()) === $role->permissions->count() && count($permissions->flatten()) > 0 ? 'checked' : '' }}>
