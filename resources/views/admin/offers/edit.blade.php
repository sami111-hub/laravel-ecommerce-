...
<div class="container-fluid py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2><i class="bi bi-pencil text-primary"></i> تعديل العرض</h2>
                    ...
                    <div class="card-body">
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number" class="form-control @error('discount_percentage') is-invalid @enderror" 
                                       ...
                                       value="{{ old('discount_percentage', $offer->discount_percentage) }}" min="0" max="100" required>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('description') is-invalid @enderror" 
                                      id="description" name="description" rows="3" required>{{ old('description', $offer->description) }}</textarea>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-3">
                                ...
                                <input type="number" step="0.01" class="form-control @error('original_price') is-invalid @enderror" 
                                       ...
                                       value="{{ old('original_price', $offer->original_price) }}" placeholder="مثال: 299.99" min="0">
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="number" step="0.01" class="form-control @error('offer_price') is-invalid @enderror" 
                                       ...
                                       value="{{ old('offer_price', $offer->offer_price) }}" placeholder="مثال: 199.99" min="0">
                            ...
                            <div class="col-md-6">
                                ...
                                @if($offer->image)
                                    <div class="mb-2" id="currentImage">
                                        ...
                                        <p class="text-muted small mt-1"><i class="bi bi-info-circle"></i> اختر صورة جديدة لاستبدالها</p>
                                    </div>
                                @endif
                                ...
                                <div id="imagePreview" class="mt-2" style="display: none;">
                                    <p class="text-success small"><i class="bi bi-check-circle"></i> الصورة الجديدة:</p>
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" id="category_slug" name="category_slug" onchange="onCategoryChange()">
                                ...
                                @foreach($categories as $category)
                                    <option value="{{ $category->slug }}" {{ old('category_slug', $offer->category_slug) == $category->slug ? 'selected' : '' }}>
                                        {{ $category->name }}
                                    </option>
                                @endforeach
                            </select>
...
const existingSpecs = @json($offer->specifications ?? []);
const existingCustomSpecs = @json($offer->custom_specifications ?? []);
...
function onCategoryChange() {
    ...
    renderSpecsFields(slug, existingSpecs);
}
...
document.addEventListener('DOMContentLoaded', function() {
    onCategoryChange();
    // تحميل المواصفات المخصصة الحالية
    if (existingCustomSpecs) {
        Object.entries(existingCustomSpecs).forEach(([key, value]) => {
